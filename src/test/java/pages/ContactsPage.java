...
public boolean getDataFromContactList(Contact contact){
   ...
   // WebElement nameInContact = driver.findElement(By.xpath("//h2[contains(text(),'"+contact.getName().toString()+"')]"));
    ...
    System.out.println("OBEKT _1 : "+contact.toString());
    System.out.println("****************************************************************");
    System.out.println("OBEKT _2 : "+listContact.toString());
